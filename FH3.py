    ...
    while True:
        ...
        if rect_box and rect_cnt is not None:
            ...
            for edge, (p1, p2) in valid_edges:
                ...
                side_len_cm = pixel_length_to_cm(side_len_px, WARP_W, WARP_H, REAL_W_CM, REAL_H_CM)
        ...
        for box_pts, side_len in highlight_boxes:
            cv2.polylines(vis, [box_pts], True, (0,0,255), 3)  # 红色粗框
